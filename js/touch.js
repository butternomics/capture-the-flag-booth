...
/**
 * Clamp photo position so it always covers the frame window (no gaps)
 */
...
/**
 * Initialize touch handling on the canvas
 */
...
/**
 * Update the minimum scale (called when a new photo is loaded)
 */
